defmodule PrimeYouthWeb.UserAuth do
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      PrimeYouthWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule PrimeYouthWeb.PageLive do
        use PrimeYouthWeb, :live_view

        on_mount {PrimeYouthWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PrimeYouthWeb.UserAuth, :require_authenticated}] do
