  ...
  def render(assigns) do
    ...
    <!-- Program Icon -->
          <div class="absolute inset-0 flex items-center justify-center">
            <div class={["w-24 h-24 bg-white/20 backdrop-blur-sm flex items-center justify-center", Theme.rounded(:full)]}>
    ...
    <!-- Program Info Overlay -->
        <div class={["absolute bottom-0 left-0 right-0 rounded-t-3xl p-6", Theme.bg(:surface)]}>
          <div class="flex items-start justify-between mb-4">
            <div class="flex-1">
              <h1 class={[Theme.typography(:section_title), "mb-2", Theme.text_color(:heading)]}>{@program.title}</h1>
              ...
              <div class="flex items-center space-x-2">
                ...
                <span class={["bg-green-100 text-green-700 px-2 py-1 text-xs font-medium", Theme.rounded(:full)]}>
                  ✓ No hidden fees
                </span>
              </div>
            </div>
            <div class="text-right ml-4">
              ...
              <p class={["text-xs", Theme.text_color(:subtle)]}>{format_price(@program.price)}/week • 4 weeks</p>
    ...
    <!-- Main Content -->
        <div class="space-y-6">
          <!-- Program Description -->
          <div class={[Theme.bg(:surface), Theme.rounded(:xl), "p-6 shadow-sm border", Theme.border_color(:light)]}>
            <h3 class={[Theme.typography(:card_title), "mb-3", Theme.text_color(:heading)]}>About This Program</h3>
    ...
    <!-- What's Included -->
            <div class="space-y-2">
              <h4 class={[Theme.typography(:card_title), Theme.text_color(:heading)]}>What's Included:</h4>
    ...
    <!-- Instructor Info -->
          <div class={[Theme.bg(:surface), Theme.rounded(:xl), "p-6 shadow-sm border", Theme.border_color(:light)]}>
            <h3 class={[Theme.typography(:card_title), "mb-4", Theme.text_color(:heading)]}>Meet Your Instructor</h3>
            <div class="flex items-start space-x-4">
              <img src={@instructor.avatar} alt="Instructor" class={["w-16 h-16", Theme.rounded(:full)]} />
              <div class="flex-1">
                <h4 class={[Theme.typography(:card_title), Theme.text_color(:heading)]}>{@instructor.name}</h4>
                <p class={["text-sm mb-2", Theme.text_color(:secondary)]}>{@instructor.credentials}</p>
    ...
    <!-- Parent Reviews -->
          <div class={[Theme.bg(:surface), Theme.rounded(:xl), "p-6 shadow-sm border", Theme.border_color(:light)]}>
            <h3 class={[Theme.typography(:card_title), "mb-4", Theme.text_color(:heading)]}>What Other Parents Say</h3>
            <div class="space-y-4">
              <.review_card
                :for={review <- @reviews}
