defmodule PrimeYouthWeb.ProgramDetailLive do
          ...
          <div class="absolute inset-0 flex items-center justify-center">
            <div class="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
              <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d={@program.icon_path}></path>
              </svg>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start justify-between mb-4">
            <div class="flex-1">
              ...
              <div class="flex items-center space-x-2">
                <span :if={@program.spots_left <= 5} class={[
                  "px-2 py-1 rounded-full text-xs font-medium",
                  if(@program.spots_left <= 2, do: "bg-orange-100 text-orange-700", else: "bg-yellow-100 text-yellow-700")
                ]}>
                  Only {@program.spots_left} spots left!
                </span>
                <span class="bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs font-medium">✓ No hidden fees</span>
              </div>
            </div>
            <div class="text-right ml-4">
              <p class="text-3xl font-bold text-prime-magenta-400">{format_total_price(@program.price)}</p>
      ...
      <div class="mt-20 p-6 lg:grid lg:grid-cols-3 lg:gap-8 lg:p-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <div class="flex items-center mt-2">
                  ...
                  <span class="text-sm text-gray-600 ml-2">{@instructor.rating}/5 from {@instructor.review_count} reviews</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div class="space-y-4">
              <div :for={{review, index} <- Enum.with_index(@reviews)} class={[
                "border-l-4 pl-4",
                if(rem(index, 2) == 0, do: "border-prime-cyan-400", else: "border-prime-magenta-400")
              ]}>
        ...
        <div class="lg:col-span-1">
          ...
          <div class="lg:sticky lg:top-8">
            <div class="bg-gradient-to-r from-prime-cyan-400 to-prime-magenta-400 rounded-2xl p-6 text-white">
              ...
              <p class="text-white/90 mb-4">Secure your spot now - only {@program.spots_left} remaining!</p>
  ...
  defp sample_programs do
    [
      %{
        ...
        description: "Unleash your child's creativity through painting, drawing, sculpture, and mixed media projects.",
        long_description: "Unleash your child's creativity in our comprehensive art program! Students will explore various artistic mediums including painting, drawing, sculpting, and digital art. Our expert instructors guide each child to develop their unique artistic voice while building fundamental skills.",
        gradient_class: "bg-gradient-to-br from-yellow-400 via-orange-500 to-yellow-600",
        icon_path: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v1.5L15 4l2 7-7 2.5V15a2 2 0 01-2 2z",
      ...
      %{
        id: 2,
        title: "Chess Masters",
        description: "Learn strategic thinking and problem-solving through the ancient game of chess.",
        long_description: "Develop strategic thinking and problem-solving skills through the timeless game of chess. Perfect for developing critical thinking skills, patience, and logical reasoning in a fun, supportive environment.",
  ...
  defp sample_instructor do
    %{
      ...
      bio: "Elena specializes in fostering creativity while building technical skills. Her students have won numerous local art competitions and developed lifelong passions for the arts.",
  ...
  defp sample_reviews do
    [
      %{
        comment: "My daughter Emma has grown so much in confidence and creativity. She can't wait for art class each week!",
        parent_name: "Sarah Johnson",
        parent_avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b388?w=32&h=32&fit=crop&crop=face"
      },
      %{
        comment: "Excellent program with caring instructors. The small class size makes all the difference.",
        parent_name: "Michael Chen",
        parent_avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face"
      }
    ]
  end
