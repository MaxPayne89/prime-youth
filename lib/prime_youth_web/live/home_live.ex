      ...
      <div class={Theme.bg(:surface)}>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
            ...
            />
            <.feature_card
              gradient_class={Theme.gradient(:cool_magenta)}
            ...
            />
            <.feature_card
              gradient_class={Theme.gradient(:warm_yellow)}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <div class="grid md:grid-cols-3 gap-8">
            ...
            <.stat_display
              ...
              gradient_class={Theme.gradient(:magenta_yellow)}
            />
            <.stat_display
              value="4.9/5"
              label="Average Rating"
              gradient_class={Theme.gradient(:yellow_cyan)}
            />
          </div>
        </div>
      </div>
