defmodule PrimeYouthWeb.HomeLive do
    ...
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="bg-gradient-to-r from-prime-cyan-400 to-prime-magenta-400 text-white p-6 rounded-b-3xl">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <img src={@user.avatar} alt="Profile" class="w-12 h-12 rounded-full border-2 border-white/30">
            <div>
          ...
          <div class="flex space-x-2">
            <button class="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-colors">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5-5-5h5v-7a1 1 0 011-1h3a1 1 0 011 1v7z"></path>
              </svg>
            </button>
            <button class="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-colors">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="p-6 space-y-6">
        ...
        <div>
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-800 flex items-center">
              <svg class="w-5 h-5 mr-2 text-prime-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
              </svg>
              My Children
            </h3>
            <button class="text-prime-cyan-400 text-sm font-medium hover:text-prime-cyan-400/80">View All</button>
          </div>
          <div class="space-y-3 md:grid md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 md:gap-4 md:space-y-0">
            <div :for={child <- @children} class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <div class="mb-3">
                ...
                <div class="w-full bg-gray-200 rounded-full h-2">
                  <div class="bg-prime-cyan-400 h-2 rounded-full" style={"width: #{child.progress}%"}></div>
                </div>
              </div>
              <div class="flex flex-wrap gap-1">
                <span :for={activity <- child.activities} class="px-2 py-1 bg-gray-100 text-gray-700 rounded-full text-xs">
                  {activity}
                </span>
              </div>
            </div>
        ...
        <div>
          ...
          <div class="space-y-3">
            <div :for={activity <- @upcoming_activities} class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
  ...
  defp sample_user do
    %{
      name: "Sarah Johnson",
      avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b388?w=64&h=64&fit=crop&crop=face"
    }
  end
