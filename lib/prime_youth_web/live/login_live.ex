          ...
          <div class="bg-white/25 backdrop-blur-lg border border-white/[0.18] rounded-2xl p-6">
            <form phx-submit="login" phx-change="validate" class="space-y-6">
              ...
              <div class="flex items-center justify-between text-sm">
                ...
                <button type="button" phx-click="forgot_password" class="text-white hover:text-white/80 transition-colors">
                  Forgot password?
                </button>
              </div>
              ...
              <div class="text-center">
                <p class="text-white/80 text-sm">
                  ...
                  <.link navigate={~p"/signup"} class="text-white font-medium hover:text-white/80 transition-colors ml-1">
                    Sign up
                  </.link>
                </p>
              </div>
          ...
          <div class="w-full max-w-md">
            ...
            <form phx-submit="login" phx-change="validate" class="space-y-6">
              ...
              <div class="flex items-center justify-between text-sm">
                ...
                <button type="button" phx-click="forgot_password" class="text-prime-cyan-400 hover:text-prime-cyan-400/80 transition-colors font-medium">
                  Forgot password?
                </button>
              </div>
              ...
              <div class="text-center">
                <p class="text-gray-600 text-sm">
                  Don't have an account?
                  <.link navigate={~p"/signup"} class="text-prime-cyan-400 font-medium hover:text-prime-cyan-400/80 transition-colors ml-1">
                    Sign up
                  </.link>
                </p>
              </div>
