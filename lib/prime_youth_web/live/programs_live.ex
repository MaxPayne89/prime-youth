  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-gray-50 pb-20 md:pb-6">
        ...
        <div class="flex gap-2 overflow-x-auto pb-2">
          <button
            ...
            class={[
              ...
              if(@active_filter == filter.id, do: "bg-prime-cyan-400 text-white", else: "bg-gray-100 text-gray-700 hover:bg-gray-200")
            ]}
          >
            {filter.label}
          </button>
      ...
      <div class="p-6">
            ...
            <div class={["h-48 relative overflow-hidden", program.gradient_class]}>
              ...
              <div :if={program.spots_left <= 5} class="absolute bottom-4 left-4">
                <span class={[
                  ...
                  if(program.spots_left <= 2, do: "bg-red-100 text-red-700", else: "bg-orange-100 text-orange-700")
                ]}>
        ...
        <!-- Empty State -->
        <div :if={Enum.empty?(filtered_programs(@programs, @search_query, @active_filter))} class="text-center py-12">
  ...
  defp sample_programs do
    [
      %{
        ...
        description: "Unleash your child's creativity through painting, drawing, sculpture, and mixed media projects. Each session explores different artistic techniques and mediums.",
      ...
      %{
        id: 2,
        title: "Chess Masters",
        description: "Learn strategic thinking and problem-solving through the ancient game of chess. Perfect for developing critical thinking skills and patience.",
      ...
      %{
        ...
        description: "Hands-on science experiments and discovery. Making learning fun through interactive activities and real-world applications.",
      ...
      %{
        id: 4,
        title: "Soccer Skills",
        description: "Develop fundamental soccer skills including dribbling, passing, shooting, and teamwork. All skill levels welcome in a fun, supportive environment.",
        gradient_class: "bg-gradient-to-br from-green-500 via-emerald-600 to-teal-700",
        icon_path: "M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z",
      ...
      %{
        ...
        description: "Introduction to music through singing, dancing, and simple instruments. Builds rhythm, coordination, and musical appreciation.",
        gradient_class: "bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600",
        icon_path: "M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z M21 16c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z",
      ...
      %{
        ...
        description: "Introduction to programming concepts through fun, visual coding languages and games. Build logic skills and creativity.",
