defmodule PrimeYouthWeb.CommunityLive do
  use PrimeYouthWeb, :live_view

  import PrimeYouthWeb.CompositeComponents

  alias PrimeYouth.Community.Application.UseCases.{ListPosts, ToggleLike, AddComment}
    ...
    <!-- Feed Posts -->
        <div id="posts" phx-update="stream" class="space-y-4">
          ...
          <.empty_state
            ...
            description={
              gettext(
                "Stay tuned for updates, photos, and announcements from instructors and the Prime Youth Connect community."
              )
            }
          />
        </div>
