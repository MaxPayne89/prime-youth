defmodule PrimeYouthWeb.Parent.ParticipationHistoryLive do
  ...
  def mount(_params, _session, socket) do
    ...
    if connected?(socket) do
      ...
      Phoenix.PubSub.subscribe(PrimeYouth.PubSub, "participation_record:child_checked_in")
      Phoenix.PubSub.subscribe(PrimeYouth.PubSub, "participation_record:child_checked_out")
