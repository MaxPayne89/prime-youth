defmodule PrimeYouthWeb.SignupLive do
  ...
  def handle_event("signup", %{"signup" => params}, socket) do
    ...
    errors = validate_signup_params(first_name, last_name, email, password, password_confirmation, agree_terms)
          ...
          <div class="bg-white/25 backdrop-blur-lg border border-white/[0.18] rounded-2xl p-6">
            <form phx-submit="signup" phx-change="validate" class="space-y-4">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="space-y-1">
                  <label for="mobile-first-name" class="block text-sm font-medium text-white">First Name</label>
                  <input
                    type="text"
                ...
                <div class="space-y-1">
                  <label for="mobile-last-name" class="block text-sm font-medium text-white">Last Name</label>
                  <input
                    type="text"
                    id="mobile-last-name"
              ...
              <!-- Password Fields -->
              <div class="space-y-1">
                <label for="mobile-password" class="block text-sm font-medium text-white">Password</label>
                <input
                  type="password"
                  id="mobile-password"
              ...
              <div class="space-y-1">
                <label for="mobile-password-confirmation" class="block text-sm font-medium text-white">Confirm Password</label>
                <input
                  type="password"
              ...
              <div class="flex items-start space-x-2 text-sm">
                ...
                <label for="mobile-agree-terms" class="text-white/90 cursor-pointer">
                  I agree to the <span class="text-white font-medium underline">Terms of Service</span> and <span class="text-white font-medium underline">Privacy Policy</span>
                </label>
              </div>
              ...
              <div class="text-center">
                <p class="text-white/80 text-sm">
                  ...
                  <.link navigate={~p"/login"} class="text-white font-medium hover:text-white/80 transition-colors ml-1">
                    Sign in
                  </.link>
                </p>
              </div>
          ...
          <div class="text-center text-white max-w-md">
            <div class="inline-flex items-center justify-center w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full shadow-xl mb-6">
              <div class="w-16 h-16 bg-white rounded-xl flex items-center justify-center">
                <span class="text-2xl font-bold bg-gradient-to-r from-prime-cyan-400 to-prime-magenta-400 bg-clip-text text-transparent">PY</span>
              </div>
            </div>
          ...
          <div class="w-full max-w-md">
            ...
            <form phx-submit="signup" phx-change="validate" class="space-y-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="space-y-1">
                  <label for="desktop-first-name" class="block text-sm font-medium text-gray-700">First Name</label>
                  <input
                    type="text"
                ...
                <div class="space-y-1">
                  <label for="desktop-last-name" class="block text-sm font-medium text-gray-700">Last Name</label>
                  <input
                    type="text"
              ...
              <!-- Email Field -->
              <div class="space-y-1">
                <label for="desktop-email" class="block text-sm font-medium text-gray-700">Email</label>
                <input
                  type="email"
                  id="desktop-email"
                  name="signup[email]"
              ...
              <!-- Password Fields -->
              <div class="space-y-1">
                <label for="desktop-password" class="block text-sm font-medium text-gray-700">Password</label>
                <input
                  type="password"
                  id="desktop-password"
                  name="signup[password]"
              ...
              <div class="space-y-1">
                <label for="desktop-password-confirmation" class="block text-sm font-medium text-gray-700">Confirm Password</label>
                <input
                  type="password"
              ...
              <div class="flex items-start space-x-2 text-sm">
                ...
                <label for="desktop-agree-terms" class="text-gray-600 cursor-pointer">
                  I agree to the <span class="text-prime-cyan-400 font-medium underline">Terms of Service</span> and <span class="text-prime-cyan-400 font-medium underline">Privacy Policy</span>
                </label>
              </div>
              ...
              <div class="text-center">
                <p class="text-gray-600 text-sm">
                  Already have an account?
                  <.link navigate={~p"/login"} class="text-prime-cyan-400 font-medium hover:text-prime-cyan-400/80 transition-colors ml-1">
                    Sign in
                  </.link>
                </p>
              </div>
  ...
  defp validate_signup_params(first_name, last_name, email, password, password_confirmation, agree_terms) do
    errors = []
