defmodule PrimeYouth.Participation.Application.UseCases.GetSessionWithRoster do
  @moduledoc """
  ...
  defp session_repository do
    Application.get_env(:prime_youth, :participation)[:session_repository]
  end
  ...
  defp child_name_resolver do
    Application.get_env(:prime_youth, :participation)[:child_name_resolver]
  end
end
