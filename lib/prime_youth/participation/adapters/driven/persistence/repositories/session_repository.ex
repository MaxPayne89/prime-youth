defmodule PrimeYouth.Participation.Adapters.Driven.Persistence.Repositories.SessionRepository do
  @moduledoc """
  ...
  @behaviour PrimeYouth.Participation.Domain.Ports.ForManagingSessions
