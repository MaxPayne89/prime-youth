defmodule PrimeYouth.Identity.Adapters.Driven.Persistence.Repositories.ProviderProfileRepository do
  @moduledoc """
  ...
  @behaviour PrimeYouth.Identity.Domain.Ports.ForStoringProviderProfiles

  import Ecto.Query

  alias PrimeYouth.Identity.Adapters.Driven.Persistence.Mappers.ProviderProfileMapper
