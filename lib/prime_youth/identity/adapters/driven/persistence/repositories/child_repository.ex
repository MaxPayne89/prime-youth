defmodule PrimeYouth.Identity.Adapters.Driven.Persistence.Repositories.ChildRepository do
  @moduledoc """
  ...
  @behaviour PrimeYouth.Identity.Domain.Ports.ForStoringChildren

  import Ecto.Query

  alias PrimeYouth.Identity.Adapters.Driven.Persistence.Mappers.ChildMapper
