defmodule PrimeYouth.Identity.Adapters.Driven.Persistence.Repositories.ParentProfileRepository do
  @moduledoc """
  ...
  @behaviour PrimeYouth.Identity.Domain.Ports.ForStoringParentProfiles

  import Ecto.Query

  alias PrimeYouth.Identity.Adapters.Driven.Persistence.Mappers.ParentProfileMapper
