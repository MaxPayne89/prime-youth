defmodule PrimeYouth.Identity.Domain.Models.ParentProfile do
  @moduledoc """
  Pure domain entity representing a parent profile in the Identity bounded context.

  This is the aggregate root for parent-related operations in the Identity context.
