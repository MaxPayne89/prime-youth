defmodule PrimeYouth.Identity.Domain.Ports.ForStoringParentProfiles do
  @moduledoc """
  Repository port for storing and retrieving parent profiles in the Identity bounded context.
