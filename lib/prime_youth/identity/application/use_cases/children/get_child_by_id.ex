defmodule PrimeYouth.Identity.Application.UseCases.Children.GetChildById do
  @moduledoc """
  ...
  @repository Application.compile_env!(:prime_youth, [:identity, :for_storing_children])
