defmodule PrimeYouth.Shared.Adapters.Driven.Events.PubSubEventPublisher do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> alias PrimeYouth.Shared.Domain.Events.DomainEvent
      iex> alias PrimeYouth.Shared.Adapters.Driven.Events.PubSubEventPublisher
  ...
  defp pubsub_server do
    ...
    |> Keyword.get(:pubsub, PrimeYouth.PubSub)
  end
