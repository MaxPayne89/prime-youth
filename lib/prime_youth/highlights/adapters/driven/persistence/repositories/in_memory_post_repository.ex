defmodule PrimeYouth.Highlights.Adapters.Driven.Persistence.Repositories.InMemoryPostRepository do
  @moduledoc """
  ...
  @behaviour PrimeYouth.Highlights.Domain.Ports.ForManagingPosts
