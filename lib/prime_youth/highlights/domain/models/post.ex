defmodule PrimeYouth.Highlights.Domain.Models.Post do
  @moduledoc """
  Domain entity representing a social post in the Highlights feed.
  ...
  alias PrimeYouth.Highlights.Domain.Models.Comment
