defmodule PrimeYouth.Highlights.Domain.Events.HighlightsEvents do
  @moduledoc """
  Factory module for creating Highlights domain events.

  Provides convenience functions to create standardized DomainEvent structs
  for post-related events in the Highlights context.
  ...
  ## Usage
      ...
      event = HighlightsEvents.comment_added(post, "Author", "Comment text")
  ...
  ## Examples
      ...
      iex> event = HighlightsEvents.comment_added(post, "John", "Great post!")
  ...
  ## Examples
      ...
      iex> event = HighlightsEvents.post_liked(post)
      iex> event.event_type
      :post_liked
  ...
  ## Examples
      ...
      iex> event = HighlightsEvents.post_unliked(post)
      iex> event.event_type
      :post_unliked
      iex> event.payload.likes_count
      14
