defmodule PrimeYouth.Highlights.Application.UseCases.ListPosts do
  @moduledoc """
  Use case for listing all posts in the Highlights feed.
  ...
  The repository implementation is configured via Application config:
      ...
      config :prime_youth, :highlights,
        repository: PrimeYouth.Highlights.Adapters.Driven.Persistence.Repositories.InMemoryPostRepository
  ...
  @doc """
  Executes the use case to list all posts in the Highlights feed.
