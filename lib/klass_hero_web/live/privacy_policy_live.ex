  ...
  defp privacy_sections do
    [
      %{
        ...
        content: """
        <p class="mb-4">Welcome to Klass Hero Connect's Privacy Policy. At Klass Hero Connect, we connect families with enriching afterschool programs, camps, and educational activities. We understand that when you entrust us with your family's information, you expect us to handle it responsibly and transparently.</p>
      ...
      %{
        ...
        content: """
        <p class="mb-4">Klass Hero Connect is designed to help parents manage their children's activities. We take special care with children's information:</p>
      ...
      %{
        ...
        content: """
        <p class="mb-4">Klass Hero Connect uses minimal tracking to provide essential functionality:</p>
      ...
      %{
        ...
        <ul class="list-disc pl-6 space-y-2 mb-4">
          ...
          <li>Continued use of Klass Hero Connect after changes constitute acceptance of the updated policy</li>
        </ul>
