defmodule KlassHero.Community.Adapters.Driven.Persistence.Repositories.InMemoryPostRepository do
  @moduledoc """
  ...
  @behaviour KlassHero.Community.Domain.Ports.ForManagingPosts
