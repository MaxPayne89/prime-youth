defmodule KlassHero.Identity.Domain.Events.IdentityIntegrationEvents do
  @moduledoc """
  Factory module for creating Identity context integration events.
  ...
  ## Examples
      ...
      iex> event = IdentityIntegrationEvents.child_data_anonymized("child-uuid")
