defmodule PrimeYouth.Attendance.Adapters.Driven.Persistence.Repositories.SessionRepositoryTest do
  @moduledoc """
  ...
  alias PrimeYouth.Attendance.Adapters.Driven.Persistence.Repositories.SessionRepository
  ...
  describe "update/1" do
    test "successfully updates session status" do
      ...
      {:ok, started} = ProgramSession.start_session(domain_session)
