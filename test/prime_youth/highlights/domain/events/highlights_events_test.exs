defmodule PrimeYouth.Highlights.Domain.Events.HighlightsEventsTest do
  ...
  describe "comment_added/5 validation" do
    test "raises when author is empty string via guard clause" do
      ...
      assert_raise FunctionClauseError, fn ->
        HighlightsEvents.comment_added(post, "", "Great post!")
      end
    end
    ...
    test "raises when author is not a binary via guard clause" do
      ...
      assert_raise FunctionClauseError, fn ->
        HighlightsEvents.comment_added(post, nil, "Great post!")
      end
    end
    ...
    test "raises when comment_text is empty string via guard clause" do
      ...
      assert_raise FunctionClauseError, fn ->
        HighlightsEvents.comment_added(post, "John", "")
      end
    end
    ...
    test "raises when comment_text is not a binary via guard clause" do
      ...
      assert_raise FunctionClauseError, fn ->
        HighlightsEvents.comment_added(post, "John", nil)
      end
    end
    ...
    test "raises when post.id is nil" do
      ...
      assert_raise ArgumentError,
                   ...
                   fn -> HighlightsEvents.comment_added(post, "John", "Great post!") end
    end
    ...
    test "succeeds with valid post and parameters" do
      ...
      event = HighlightsEvents.comment_added(post, "John", "Great post!")
    ...
    test "succeeds with valid post and custom payload" do
      ...
      event =
        HighlightsEvents.comment_added(post, "John", "Great post!", %{user_id: 123})
  ...
  describe "post_liked/3 validation" do
    test "raises when post.id is nil" do
      ...
      assert_raise ArgumentError,
                   "Post.id cannot be nil or empty",
                   fn -> HighlightsEvents.post_liked(post) end
    end
    ...
    test "succeeds with valid post" do
      ...
      event = HighlightsEvents.post_liked(post)
    ...
    test "succeeds with valid post and custom payload" do
      ...
      event = HighlightsEvents.post_liked(post, %{user_id: 123})
  ...
  describe "post_unliked/3 validation" do
    test "raises when post.id is nil" do
      ...
      assert_raise ArgumentError,
                   "Post.id cannot be nil or empty",
                   fn -> HighlightsEvents.post_unliked(post) end
    end
    ...
    test "succeeds with valid post" do
      ...
      event = HighlightsEvents.post_unliked(post)
    ...
    test "succeeds with valid post and custom payload" do
      ...
      event = HighlightsEvents.post_unliked(post, %{user_id: 123})
