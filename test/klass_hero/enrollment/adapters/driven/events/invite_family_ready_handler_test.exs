defmodule KlassHero.Enrollment.Adapters.Driven.Events.InviteFamilyReadyHandlerTest do
  use KlassHero.DataCase, async: true

  import KlassHero.Factory

  alias KlassHero.Enrollment.Adapters.Driven.Events.InviteFamilyReadyHandler
