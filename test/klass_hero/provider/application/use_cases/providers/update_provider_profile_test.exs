defmodule KlassHero.Provider.Application.UseCases.Providers.UpdateProviderProfileTest do
  ...
  setup do
    ...
    mapper = KlassHero.Provider.Adapters.Driven.Persistence.Mappers.ProviderProfileMapper
