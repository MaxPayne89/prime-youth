defmodule KlassHero.ProgramCatalog.Application.Queries.ListProgramsPaginatedIntegrationTest do
  @moduledoc """
  ...
  alias KlassHero.ProgramCatalog.Application.Queries.ListProgramsPaginated
