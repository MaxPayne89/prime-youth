defmodule KlassHero.Identity.Domain.Events.IdentityEventsTest do
  @moduledoc """
  Tests for IdentityEvents factory module.
  """
  ...
  describe "child_data_anonymized/3" do
    test "base_payload child_id wins over caller-supplied child_id" do
      ...
      event = IdentityEvents.child_data_anonymized(real_id, conflicting_payload)
    ...
    test "creates event with correct type and criticality" do
      ...
      event = IdentityEvents.child_data_anonymized(child_id)
    ...
    test "raises for nil child_id" do
      assert_raise ArgumentError, fn ->
        IdentityEvents.child_data_anonymized(nil)
      end
    end

    test "raises for empty string child_id" do
      assert_raise ArgumentError, fn ->
        IdentityEvents.child_data_anonymized("")
      end
    end
  end
end
