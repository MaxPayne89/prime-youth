defmodule KlassHero.Family.Adapters.Driven.Events.EventHandlers.PromoteIntegrationEventsTest do
  use ExUnit.Case, async: true

  import KlassHero.EventTestHelper

  alias KlassHero.Family.Adapters.Driven.Events.EventHandlers.PromoteIntegrationEvents
