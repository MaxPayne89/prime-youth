...
flowchart TB
 ...
 subgraph SignUp_Flow["Sign Up Flow"]
        ...
        P_AccountChoose{"Choose Account Type (Free / Paid Plan)"}
    ...
    V_Approved --> V_CreateProfiles & VDash
    V_CreateProfiles --> V_ProfileLimitCheck & V_PublishPrograms & V_AssignPrograms & V_Team
    ...
    Payment --> PostPayment & PostPayment & PostPayment
