...
13. **[IN REVIEW]** N+1 in StaffAssignmentHandler.add_staff_to_existing_conversations — PR #592 submitted 2026-04-04; new add_to_conversations_batch/2 port callback + insert_all
14. **[LOW]** Two-step query in `with_ended_program/2` — background job only; crosses DDD boundaries
15. **[LOW]** program_sessions.status index — verify query patterns first

## Backlog Cursor
- Next run: T5 (scan for new perf issues), T1 (revalidate commands), T6 (measurement infra)
